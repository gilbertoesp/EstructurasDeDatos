#ifndef LISTAORDEN2_H_INCLUDED
#define LISTAORDEN2_H_INCLUDED
...
public:
    ...
    */
	~ListaOrden2();
    /**
        Dado un Dato, los busca en la ListaOrden2 desde principio, guardando la informacion de la
