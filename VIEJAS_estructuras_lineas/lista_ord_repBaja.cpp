...
#include "lista_ord_repBaja.h"
using namespace std;
//**********************************************************************
lista_ord_repBaja::lista_ord_repBaja()
{
    principio = NULL;
    anterior = NULL;
}
...
//**********************************************************************
void lista_ord_repBaja::buscar(int a)
{
    caja *p;
    p = principio;
...
//**********************************************************************
void lista_ord_repBaja::agregar(int a)
{
    caja *p;
...
//**********************************************************************
int lista_ord_repBaja::borrar(int a)
{
    caja *p;
...
//**********************************************************************
void lista_ord_repBaja::pintar(void)
{
    caja *p;
    p = principio;
